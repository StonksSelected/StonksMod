...
public class BlockSTONKFLUID extends ElementsStonks.ModElement {
	@GameRegistry.ObjectHolder("stonks:stonkfluid")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("stonks:stonkfluid")
	public static final Item item = null;
	private Fluid fluid;
	public BlockSTONKFLUID(ElementsStonks instance) {
		super(instance, 35);
		fluid = new Fluid("stonkfluid", new ResourceLocation("stonks:blocks/lawa"), new ResourceLocation("stonks:blocks/lawaflow")).setLuminosity(3)
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelLoader.setCustomMeshDefinition(item, new ItemMeshDefinition() {
			...
			public ModelResourceLocation getModelLocation(ItemStack stack) {
				return new ModelResourceLocation("stonks:stonkfluid", "stonkfluid");
			}
		});
