...
import net.mcreator.stonks.item.ItemAidsLand;
...
public class WorldAidsLand extends ElementsStonks.ModElement {
	public static int DIMID = 4;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("stonks:aidsland_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldAidsLand(ElementsStonks instance) {
		super(instance, 40);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemAidsLand().setUnlocalizedName("aidsland").setRegistryName("aidsland"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension aidsland is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("aidsland", "_aidsland", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemAidsLand.block, 0, new ModelResourceLocation("stonks:aidsland", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public Vec3d getFogColor(float par1, float par2) {
			return new Vec3d(0.266666666667, 0.78431372549, 0.329411764706);
		}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag ? Blocks.STICKY_PISTON.getDefaultState().getBlock().getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
			}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? Blocks.STICKY_PISTON.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("aidsland_portal");
			setRegistryName("aidsland_portal");
			setLightLevel(0F);
		}
		...
		public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random random) {
			...
			if (random.nextInt(110) == 0)
				world.playSound(pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5,
						(net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation(("stonks:stonks"))),
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != Blocks.STICKY_PISTON.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == Blocks.STICKY_PISTON.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != Blocks.STICKY_PISTON.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != Blocks.STICKY_PISTON
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = Blocks.EMERALD_ORE.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("stonks:bigmuchoof")),
				Biome.REGISTRY.getObject(new ResourceLocation("stonks:stonktrees")), Biome.REGISTRY.getObject(new ResourceLocation("plains")),
